...
public class CurrencyConverterGUI extends Application {
    ...
    public void start(Stage stage) {
        ...
        // initiate scene
        Scene scene = new Scene(layout, ViewSettings.WINDOWDEFAULTWIDTH, ViewSettings.WINDOWDEFAULTHEIGHT);
        scene.getStylesheets().add("styles.css");
        stage.setScene(scene);
        stage.setTitle(ViewSettings.WINDOWTITLE);
        stage.show();
    }
    ...
    public void setSelectionError(String inputOrOutputCurrency) {
        ...
        if(inputOrOutputCurrency.equalsIgnoreCase("input")) {
            ...
            inputCurrencyErrorLabel.setTextFill(ViewSettings.ERRORCOLOR);
        } else if (inputOrOutputCurrency.equalsIgnoreCase("output")) {
            outputCurrencyErrorLabel.setText(errorMessage);
            outputCurrencyErrorLabel.setTextFill(ViewSettings.ERRORCOLOR);
        }
    }
}
